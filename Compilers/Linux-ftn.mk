# svn $Id: Linux-ftn.mk 709 2014-01-23 20:09:38Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ifdef USE_NETCDF4
    ...
    NETCDF_INCDIR ?=/opt/cray/netcdf/4.2.0/pgi/119/include
    NETCDF_LIBDIR ?=/opt/cray/netcdf/4.2.0/pgi/119/lib
...
$(SCRATCH_DIR)/mod_ncparam.o: FFLAGS += -N 255
$(SCRATCH_DIR)/mod_strings.o: FFLAGS += -N 255
$(SCRATCH_DIR)/analytical.o: FFLAGS += -N 255
$(SCRATCH_DIR)/biology.o: FFLAGS += -N 255
ifdef USE_ADJOINT
$(SCRATCH_DIR)/ad_biology.o: FFLAGS += -N 255
endif
ifdef USE_REPRESENTER
$(SCRATCH_DIR)/rp_biology.o: FFLAGS += -N 255
endif
ifdef USE_TANGENT
$(SCRATCH_DIR)/tl_biology.o: FFLAGS += -N 255
endif
